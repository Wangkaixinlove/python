...
#### 第一天 下载之路 2019.7.11  
start  
1.下载home-brew,目的是为了更新python，mac本自带2.7.0版本，最好实现2.版本与3.版本共存
...
2.读后感觉情感分析应用场景比较局限，属于自然语言处理的一部分，分析一句话作者和读者的情感
3.知识图谱主要和数据结合在一起，跟数据库和关系息息相关,应用场景表广阔：个性化推荐、搜索等等比较常用
...
9.如何使用模块unittest 中的工具来为函数和类编写测试;如何编写继承unittest.TestCase 的类，以及如何编写测试方法，以核实函数和类的行为
